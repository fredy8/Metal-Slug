...
import com.madpanda.metalslug.screens.game.scene.PlayerInput;
...
public class Player extends Character {
	...
	public Player(Scene scene, float x, float y) {
		super(new Rectangle(x, y, WIDTH, HEIGHT), scene, 100);
		...
		setGraphicalComponent(new TextureRender(this, ((Body) this.getPhysicalComponent()).getRectangle(), "images/game/bueno9.png"));
